...
public class LanguageManager : MonoBehaviour
{
    ...
    void SetupDictionaries()
    {
        pt = new Dictionary<string, string>()
        {
            ...
            { "SELECT_PRESS_ENTER", "PRESSIONE ENTER PARA CONTINUAR" },
            { "SELECT_CHOOSE_BOTH", "SELECIONE UM PERSONAGEM PARA CADA JOGADOR" },
            { "BOT_OPTIONS_HINT", "ESCOLHA O ESTILO E A DIFICULDADE DO SEU BOT." },
            { "SELECT_DIFFICULTY_BOT", "DIFICULDADE (BOT)" },
            { "SELECT_STYLE_BOT", "ESTILO DO BOT" },
            { "SELECT_CONFIRM", "CONFIRMAR" },
            { "SELECT_BACK", "VOLTAR" },
            { "SELECT_DETAILS", "DETALHES" },
            { "SELECT_NAVIGATE", "NAVEGAR" },
            { "START_GAME",       "INICIAR" },
            { "BTN_SALVAR",       "SALVAR" },
            ...
            { "CHAR_STAT_FORCE",     "Força" },
            { "CHAR_STAT_ENERGY",    "Energia" },
            { "CHAR_DAMAGE",         "Dano" },
            { "CHAR_RANGE",          "Alcance" },
            { "CHAR_COST",           "Custo" },
        ...
        en = new Dictionary<string, string>()
        {
            ...
            { "SELECT_PRESS_ENTER", "PRESS ENTER TO CONTINUE" },
            { "SELECT_CHOOSE_BOTH", "SELECT A CHARACTER FOR EACH PLAYER" },
            { "BOT_OPTIONS_HINT", "CHOOSE YOUR BOT'S STYLE AND DIFFICULTY." },
            { "SELECT_DIFFICULTY_BOT", "DIFFICULTY (BOT)" },
            { "SELECT_STYLE_BOT", "BOT STYLE" },
            { "SELECT_CONFIRM", "CONFIRM" },
            { "SELECT_BACK", "BACK" },
            { "SELECT_DETAILS", "DETAILS" },
            { "SELECT_NAVIGATE", "NAVIGATE" },
            { "START_GAME",       "START" },
            { "BTN_SALVAR",       "SAVE" },
            ...
            { "CHAR_STAT_FORCE",     "Strength" },
            { "CHAR_STAT_ENERGY",    "Energy" },
            { "CHAR_DAMAGE",         "Damage" },
            { "CHAR_RANGE",          "Range" },
            { "CHAR_COST",           "Cost" },
            { "CHAR_SPEED",          "Speed" },
